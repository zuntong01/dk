### __`TASK_01-2_git-clone-source (MSE).md`__

### 설명 : Gitlab repo(project)에서 Tekton TASK 내부의 Workspace 로 git-init 명령으로 소스를 가져옴
...
## ----------------------------------------------------------------------------------------------------------------------------------------------
      ...
      ## 실행되는 TASK(컨테이너) 권한을 제어하고자 6555321 UID로 설정
      securityContext:
         runAsNonRoot: true
         runAsUser: 655321
